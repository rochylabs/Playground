...
export default function ListeningExercise({ part, onSubmit }: { part: ListeningPart; onSubmit?: (earned: number, total: number, results: QuestionResult[]) => void }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
      {/* Exam header */}
      <div className="bg-green-700 px-4 sm:px-6 py-3 flex items-center justify-between gap-2">
        <div>
      ...
      {/* Footer */}
      <div className="px-4 sm:px-6 py-4 border-t border-gray-200 bg-gray-50 flex flex-wrap items-center justify-between gap-3">
        {submitted ? (
          <>
